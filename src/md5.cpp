...
static void bytes_encode(unsigned char *output, uint32 *input,
		unsigned int len) {
	unsigned int i, j;
...
static void bytes_decode(uint32 *output, unsigned char *input,
		unsigned int len) {
	unsigned int i, j;
 ...
 */
void MD5Transform(uint32 buf[4], uint32 const cin[16]) {
